      ...
      <>
        <main className="grid min-h-full place-items-center py-24 px-6 sm:py-32 lg:px-8 md:h-[calc(100vh_-_300px)]">
          <div className="text-center">
            <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Thank you {name}!</h1>
...
EnquirySuccess.getLayout = (page: ReactElement) => <Layout>{page}</Layout>
