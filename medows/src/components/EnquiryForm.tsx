...
const EnquiryFrom = () => {
    ...
    const handleFormSubmit = (e: React.FormEvent<EventTarget>) => {
        ...
        .then((data) => {
          ...
          router.push({ pathname: '/enquirySuccess', query: { name: name } })
        }
      )
      .catch((error) => {
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-1">
                <input
                  ...
                  id="name"
                  autoComplete="name"
                  className="block w-full rounded-md border-gray-300 py-3 px-4 shadow-sm focus:border-rose-500 focus:ring-rose-500"
